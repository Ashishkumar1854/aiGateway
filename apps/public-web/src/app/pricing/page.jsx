    ...
    <div className="bg-white text-slate-800 min-h-screen">
      ...
      <section className="relative overflow-hidden pt-24 pb-20 border-b border-slate-100">
        ...
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 relative z-10">
          ...
          <h1 className="text-4xl font-extrabold text-slate-900 sm:text-6xl tracking-tight mt-5 leading-tight">Pricing & Plans</h1>
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 relative z-10">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={item.q} className="rounded-2xl border border-slate-200 bg-slate-50 p-5 hover:border-slate-350 transition-all duration-200">
                <h3 className="text-xs sm:text-sm font-bold text-slate-800">{item.q}</h3>
                <p className="mt-2.5 text-xs text-slate-555 leading-relaxed">{item.a}</p>
              </div>
            ))}
          </div>
        </div>
